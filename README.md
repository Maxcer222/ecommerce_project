...
🔗 **[Launch E-Commerce Demo](ССЫЛКА_НА_AWS_ЗДЕСЬ)**
...
## 📦 Project Structure
* `/ecommerce-project` — React-based frontend application.
* `/ecommerce-backend` — Node.js server handling products and logic.
